...
public class mainFormController implements Initializable {
    ...
    // FIX: Add @FXML annotations to dashboard labels
    @FXML
...
//    private BarChart<?, ?> dashboard_CustomerChart;
    ...
    public void dashboardDisplayNC() {
        ...
        if (dashboard_NC == null) {
            System.err.println("dashboard_NC is null - check FXML file and fx:id");
            return;
        }
    ...
    public void dashboardDisplayTI() {
        ...
        if (dashboard_TI == null) {
            System.err.println("dashboard_TI is null - check FXML file and fx:id");
            return;
        }
    ...
    public void dashboardTotalI() {
        // FIX: Add null check
        if (dashboard_TotalI == null) {
            System.err.println("dashboard_TotalI is null - check FXML file and fx:id");
            return;
        }
    ...
    public void dashboardNSP() {
        // FIX: Add null check
        if (dashboard_NSP == null) {
            System.err.println("dashboard_NSP is null - check FXML file and fx:id");
            return;
        }
    ...
    // Uncomment and fix chart methods if needed
//    public void dashboardIncomeChart() {
//        if (dashboard_incomeChart == null) {
//            System.err.println("dashboard_incomeChart is null - check FXML file and fx:id");
//            return;
//        }
//        
...
//        if (dashboard_CustomerChart == null) {
//            System.err.println("dashboard_CustomerChart is null - check FXML file and fx:id");
//            return;
//        }
//        
...
//    }
    ...
    // ... [Rest of the methods remain the same - just continue with your existing code]
    ...
    public void inventoryImportBtn() {
        ...
        if (file != null) {
            ...
            image = new Image(file.toURI().toString(), 132, 120, false, true);
    ...
    public void inventorySelectData() {
        ...
        image = new Image(path, 132, 120, false, true);
        inventory_imageView.setImage(image);
    }
    ...
    public void menuReceiptBtn() {
        ...
        if (totalP == 0 || menu_amount.getText().isEmpty()) {
            ...
            try {
                ...
                JasperDesign jDesign = JRXmlLoader.load("C:\\Users\\ART3M1S\\JavaFX\\DiGiMaRt\\src\\digimart\\report.jrxml");
...
//            dashboardCustomerChart();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // FIX: Add null checks before calling dashboard methods
        if (dashboard_form != null && dashboard_form.isVisible()) {
            dashboardDisplayNC();
            dashboardDisplayTI();
            dashboardTotalI();
            dashboardNSP();
